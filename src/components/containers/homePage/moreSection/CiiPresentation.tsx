...
export const CiiPresentation = () => {
    return (
        <section id="krma-presentation" className="flex flex-col text-brand-midnight lg:py-24 py-16 lg:px-24 gap-8">
            ...
            <h2 className="md:flex hidden flex-col justify-center text-center md:text-[2.5rem] text-[22px] font-brico-gro font-bold uppercase tracking-widest px-4">
                Récupérez 20%
                <span>de votre investissement grâce au CII</span>
            </h2>
            <h2 className="md:hidden flex text-center items-center justify-center text-[22px] px-4 font-brico-gro font-bold uppercase tracking-widest">
