...
export const CiiPresentation = () => {
    return (
        <section
            ...
            className="flex flex-col justify-center items-center text-brand-midnight lg:py-24 py-16 md:px-16 px-8 gap-8"
        >
            <AgrementBadge className="shrink-0 w-45 h-44 md:hidden self-center" />
            <h2 className="md:flex hidden flex-col justify-center text-center md:text-[2.5rem] text-[22px] font-brico-gro font-bold uppercase tracking-wide">
                Récupérez 20%
                <span>de votre investissement grâce au CII</span>
            </h2>
            <h2 className="md:hidden flex text-center items-center justify-center text-[22px] font-brico-gro font-bold uppercase tracking-wide">
