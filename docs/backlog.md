...
## Mode 1 — CEO signals
*(Priorité absolue — 7-8 posts/mois. Voix CTO, conséquence business. Jamais de hype, jamais de généralités : chaque angle encode le mécanisme technique derrière le symptôme CEO.)*
...
*(1 post/mois max. Voix CTO technique avec thèse tranchée. Pipeline livre blanc + positionnement fort. Ne pas dépasser ce rythme avant que des CEOs soient dans la bulle.)*
