        ...
        <>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-3 text-brand-fine-blue md:text-lg text-base leading-relaxed">
                    <p>
                        Un audit, ça tourne généralement autour de quelques milliers d&apos;euros. Ce n&apos;est pas anodin. Avant
                        d&apos;y aller, il faut savoir si vous avez vraiment un problème tech - ou si
                        c&apos;est autre chose.
                    </p>
                    <p>
                        ...
                        improvisés avec des fondateurs qui ont des questions tech. Beaucoup de CEOs
                        m&apos;ont aussi mis en relation avec des amis qui avaient besoin d&apos;un regard
                        externe. Je formalise simplement ce qui existe déjà.
                    </p>
                    <p>
                        Deux créneaux par semaine, une session par CEO, 45 minutes en visio. Vous
                        m&apos;indiquez votre situation à l&apos;inscription, et on en parle sans filtre.
                        Pas de rapport, pas d&apos;engagement, pas d&apos;argumentaire de vente.
                    </p>
                    <p>
                        Je vous dis ce que j&apos;observe. Si vous avez un vrai problème, vous repartez
                        avec un point de vue clair dessus. Si vous n&apos;en avez pas, je vous le dis aussi.
                    </p>
                </div>
                <CtaButton
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4 text-brand-fine-blue leading-relaxed">
                    <p>
                        Vous êtes CEO d&apos;une startup de 10 à 80 personnes. Vous avez
                        une équipe technique, un doute tech qui revient, et vous ne savez pas si ça justifie
                        d&apos;investir.
                    </p>
                    <div className="flex flex-col gap-4 pl-4 border-l-2 border-brand-giants/40">
                        <p>
                            ...
                            Pas parce que vous ne voyez pas l&apos;intérêt d&apos;un regard externe - mais
                        ...
                        <p>
                            ...
                            Ou vous avez un doute diffus, pas encore formulé. 45 minutes suffisent souvent
                            à savoir si c&apos;est réel.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-col gap-6 text-brand-fine-blue leading-relaxed">
                    <div className="flex gap-4 items-start">
                        ...
                        <p>
                            ...
                            vous décrivez votre situation en quelques lignes. Le problème que vous
                            percevez, ce qui vous préoccupe, le contexte de votre équipe.
                        </p>
                    </div>
                    <div className="flex gap-4 items-start">
                        <span className="font-brico-gro font-bold text-brand-midnight text-lg shrink-0 w-6">
                        ...
                        <p>
                            <span className="font-semibold text-brand-midnight">Pendant 45 minutes,</span>{" "}
                            on creuse ensemble. Je pose des questions, vous répondez. Je vous dis ce que
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <p>
                            <span className="font-semibold text-brand-midnight">À la fin,</span> vous
                            avez un point de vue externe, honnête, sur ce que vous vivez. Si un audit a
                            du sens, je vous le dirai. Si ce n&apos;est pas le cas, je vous le dirai
                            aussi.
                        </p>
                    </div>
                </div>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4 text-brand-fine-blue leading-relaxed">
                    ...
                    <p>
                        Ce n&apos;est pas un argumentaire de vente déguisé. Je ne cherche pas à vous
                        convaincre de quoi que ce soit. J&apos;ai mis en place ce programme parce que
                        j&apos;ai été CEO moi aussi, et que j&apos;aurais aimé avoir accès à ce type
                        d&apos;échange avant d&apos;investir.
                    </p>
                    <p>
                        J&apos;ai passé 7 ans CTO chez lePERMISLIBRE, de 3 développeurs à 30,
                        jusqu&apos;à l&apos;introduction en bourse. J&apos;ai aussi fondé deux startups.
                        Les questions que vous vous posez, je les ai posées des deux côtés de la table.
                    </p>
                </div>
                <CtaButton
