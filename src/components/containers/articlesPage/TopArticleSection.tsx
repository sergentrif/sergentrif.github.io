    ...
    return (
        <div className="flex flex-col pb-16">
            <div className="flex gap-6 md:gap-12 mb-4 md:mb-0">
                ...
                <div className="flex flex-col items-start justify-start md:justify-between md:mt-8">
                    <h2 className="font-bold font-brico-gro uppercase tracking-wide md:text-[2.5rem] text-3xl max-w-[47rem]">
                        Mes articles
                    </h2>
                    <p className="text-brand-fine-blue hidden md:flex max-w-4xl items-end w-full md:text-base text-sm">
