...
import profil_pic from "@/assets/images/adrien-blandin.webp";
        ...
        <div className="flex flex-col pb-16">
            <div className="flex gap-6 md:gap-12 mb-8 md:mb-0">
                ...
                <div className="flex flex-col md:justify-around justify-center">
                    <h1 className="font-bold font-brico-gro uppercase tracking-wide md:text-3xl text-xl max-w-[47rem] md:justify-center">
                    ...
                    <p className="text-brand-fine-blue hidden md:flex max-w-4xl w-full md:text-lg text-base">
                        ...
                        <Link href="/audit" className="underline font-bold ml-1">
            ...
            <p className="text-brand-fine-blue md:hidden max-w-4xl w-full text-base">
                ...
                d&apos;affaires.{" "}
                <Link href="/audit" className="underline font-bold">
                    Voir comment j&apos;interviens
                </Link>
                .
            </p>
