...
| post    | P1       | Rendre du temps à un fondateur                                                     | La vraie valeur du CTO fractionnel = le temps retrouvé                                                       | Cas A          | objow      | publié  |
...
| post    | P1       | L'IA menace toute l'industrie du service                                           | L'automatisation qui vient pour l'immatériel — code, design, conseil, vidéo                                  | opinion        | -          | publié  |
