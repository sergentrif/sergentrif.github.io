        ...
        <section className="flex flex-col pt-12 pb-16">
            ...
            <div className="flex flex-col md:gap-16 gap-10 mx-auto lg:px-36 md:px-16 sm:px-12 px-4 w-full max-w-6xl">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-brand-fine-blue leading-relaxed">{"Ce site collecte uniquement des données de navigation anonymes via Google Analytics :"}</p>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-brand-fine-blue leading-relaxed">
                        ...
                        <a href={`mailto:${legal.email}`} className="font-semibold text-brand-midnight hover:underline underline-offset-4">
                            {legal.email}
                        </a>
                    </p>
                </div>
